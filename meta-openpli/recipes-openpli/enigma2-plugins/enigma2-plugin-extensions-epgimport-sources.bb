SUMMARY = "XMLTV sources and channels for the EPGImporter"
...
SRC_ORIGIN ?= "${CODEWEBSITE}/EPGimport-Sources.git;protocol=https;branch=main"
SRC_URI := "${SRC_ORIGIN} "

S = "${WORKDIR}/git"

RREPLACES_${PN} = "enigma2-plugin-extensions-xmltvimport-rytec enigma2-plugin-extensions-epgimport-rytec"
RCONFLICTS_${PN} = "enigma2-plugin-extensions-xmltvimport-rytec enigma2-plugin-extensions-epgimport-rytec"
